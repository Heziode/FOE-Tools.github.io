    ...
    return h(
      this.as,
      {
        class: {
          ...
          // eslint-disable-next-line max-len
          "border-gray-300 dark:border-gray-600 bg-white focus:border-gray-300 dark:focus:border-gray-600": !this.formControl.isInvalid,
          "border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 dark:bg-opacity-25 dark:bg-red-900 bg-red-100": this.formControl
            .isInvalid,
